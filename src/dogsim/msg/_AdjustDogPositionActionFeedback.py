"""autogenerated by genpy from dogsim/AdjustDogPositionActionFeedback.msg. Do not edit."""
import sys
...
class AdjustDogPositionActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "dogsim/AdjustDogPositionActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','dogsim/AdjustDogPositionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(AdjustDogPositionActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = dogsim.msg.AdjustDogPositionFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = dogsim.msg.AdjustDogPositionFeedback()
