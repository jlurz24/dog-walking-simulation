"""autogenerated by genpy from dogsim/MoveRobotActionResult.msg. Do not edit."""
import sys
...
class MoveRobotActionResult(genpy.Message):
  ...
  _type = "dogsim/MoveRobotActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','dogsim/MoveRobotResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = dogsim.msg.MoveRobotResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = dogsim.msg.MoveRobotResult()
