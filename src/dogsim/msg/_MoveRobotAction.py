"""autogenerated by genpy from dogsim/MoveRobotAction.msg. Do not edit."""
import sys
...
class MoveRobotAction(genpy.Message):
  _md5sum = "b13c7412b17eaf7205ca8b3104266954"
  _type = "dogsim/MoveRobotAction"
...
================================================================================
MSG: dogsim/MoveRobotActionGoal
...
================================================================================
MSG: dogsim/MoveRobotActionResult
# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======
...
================================================================================
MSG: dogsim/MoveRobotResult
# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======

================================================================================
MSG: dogsim/MoveRobotActionFeedback
# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======
...
"""
  ...
  _slot_types = ['dogsim/MoveRobotActionGoal','dogsim/MoveRobotActionResult','dogsim/MoveRobotActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.action_goal is None:
        self.action_goal = dogsim.msg.MoveRobotActionGoal()
      if self.action_result is None:
        self.action_result = dogsim.msg.MoveRobotActionResult()
      if self.action_feedback is None:
        self.action_feedback = dogsim.msg.MoveRobotActionFeedback()
    else:
      self.action_goal = dogsim.msg.MoveRobotActionGoal()
      self.action_result = dogsim.msg.MoveRobotActionResult()
      self.action_feedback = dogsim.msg.MoveRobotActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_3I.pack(_x.action_goal.goal.position.header.seq, _x.action_goal.goal.position.header.stamp.secs, _x.action_goal.goal.position.header.stamp.nsecs))
      _x = self.action_goal.goal.position.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_3d3I.pack(_x.action_goal.goal.position.point.x, _x.action_goal.goal.position.point.y, _x.action_goal.goal.position.point.z, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.position.header.seq, _x.action_goal.goal.position.header.stamp.secs, _x.action_goal.goal.position.header.stamp.nsecs,) = _struct_3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_goal.goal.position.header.frame_id = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.position.header.frame_id = str[start:end]
      _x = self
      start = end
      end += 36
      (_x.action_goal.goal.position.point.x, _x.action_goal.goal.position.point.y, _x.action_goal.goal.position.point.z, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_3d3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
