"""autogenerated by genpy from dogsim/AdjustDogPositionActionResult.msg. Do not edit."""
import sys
...
class AdjustDogPositionActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "dogsim/AdjustDogPositionActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','dogsim/AdjustDogPositionResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(AdjustDogPositionActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = dogsim.msg.AdjustDogPositionResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = dogsim.msg.AdjustDogPositionResult()
